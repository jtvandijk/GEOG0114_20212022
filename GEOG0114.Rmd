...
```{r 04-lecture, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_msstream('a4c39843-fb84-416a-b18d-ef151cb81595') %>% use_align('left')
```
[[Lecture slides]](https://github.com/jtvandijk/GEOG0114/tree/master/data/slides/w07_psa.pdf) [[Watch on MS stream]](https://web.microsoftstream.com/video/a4c39843-fb84-416a-b18d-ef151cb81595)
...
```{r 09-lecture, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
...
- calculate the total number of people associated with each cluster group **for England and Wales as a whole** (not just Liverpool but also not Great Britain as a whole!); and
