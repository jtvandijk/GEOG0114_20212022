...
Next, we need to assign weights to each neighboring polygon. In our case, each neighboring polygon will be assigned equal weight with `style='W'`. After this, we can calculate a value for the Global Moran's I. 
