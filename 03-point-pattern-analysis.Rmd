...
## Lecture recording {#lecture_w06}
Due to some technical error this week's lecture Microsoft Team's did not save the recording to Microsoft Stream, and as such is not available. You can still download the lecture slides: [[Lecture slides]](https://github.com/jtvandijk/GEOG0114/tree/master/data/slides/w06_psa.pdf)
