...
```{r 06-quadrat-count, warnings=FALSE, message=FALSE, cache=FALSE}
...
```{r 06-chi-square-it, warnings=FALSE, message=FALSE, cache=FALSE}
...
```{r 06-kernel-density-estimation, warnings=FALSE, message=FALSE, cache=FALSE}
...
```{r 06-kernel-density-estimation-kernels, warnings=FALSE, message=FALSE, cache=FALSE}
